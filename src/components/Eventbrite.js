                    ...
                    <div className="flex flex-wrap items-center sm:-mx-3">
                        ...
                        <div className="w-full md:w-1/2">
                            ...
                            <div className="relative mt-16 flex flex-col sm:flex-row sm:space-x-4">
                                <a href={link} className="flex sb-component-button-primary items-center w-full px-6 py-3 mb-3 text-lg text-white bg-indigo-600 rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto">
                                    Anmelden
