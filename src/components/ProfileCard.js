...
const ProfileCard = ({annotationPrefix,name,job,location,description,button,facebook,twitter,github,unsplash,dribbble,instagram,youtube}) => {
    return (
        <div className="transition ease-in-out delay-150 hover:rotate-0 -rotate-1 max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0" data-sb-field-path={annotationPrefix}>
