...
const ProfileCard = ({ annotationPrefix, name, job, location, description, button, facebook, twitter, github, unsplash, dribbble, instagram, youtube }) => {
    return (
        <div className="w-screen flex justify-center">
            <blockquote className="flex items-center justify-center  lg:w-1/2 w-3/4 col-span-1 p-6 mt-4 bg-white rounded-lg shadow">
                <div className="flex flex-col" >
                    <div className="relative pl-12">
                        ...
                        <p className="mt-2 text-sm pr-4 text-gray-600 sm:text-base lg:text-sm xl:text-base">I can't express enough, how amazing this service has been for my company.</p>
                    </div>
