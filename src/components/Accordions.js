                    ...
                    >
                        {
                            props.accordions.map((tab, index) =>
                                <li key={index} className="-mb-px mr-2 last:mr-0 flex-auto transition-all">
                                    <a
                                        className={
                                            "text-xs font-bold uppercase px-5 py-3 shadow-lg rounded-t-sm rounded-l-lg block leading-normal " +
                                            (openTab === index
                                    ...
                                    <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-3 shadow-lg rounded-r-sm rounded-b-small">
