...
export default function PopupLink(props) {
    ...
    return (
        <section className="w-screen h-8 p-2 flex justify-center relative">
            <Link

                onClick={() => setPopup(!popup)}
                aria-label={altText}
                id={cssId}
                className={classNames('m-4', 'p-6', 'cursor-pointer', 'sb-component', 'sb-component-block', style === 'link' ? 'sb-component-link' : 'sb-component-button', cssClasses, {
