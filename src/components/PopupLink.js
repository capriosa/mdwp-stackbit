...
export default function PopupLink(props) {
    ...
    return (
        ...
        <Link
            ...
            aria-label={altText}
            id={cssId}
            className={classNames('cursor-pointer', 'sb-component', 'sb-component-block', style === 'link' ? 'sb-component-link' : 'sb-component-button', cssClasses, {
        ...
        >
            ...
            {popup &&
                <p className="flex justify-center bg-gray-500 p-10 mt-2">One platform, one community, getting to the bottom line of everything employment. Figure out your benefits, practice for interviews, get mentored, help peers, get helped in return.</p>
